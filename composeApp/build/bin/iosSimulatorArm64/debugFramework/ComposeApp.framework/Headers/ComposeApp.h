...
__attribute__((swift_name("IosRootKt")))
@interface ComposeAppIosRootKt : ComposeAppBase
+ (UIViewController *)createRootViewController __attribute__((swift_name("createRootViewController()")));
@end
